            ...
            <div className="uk-grid-divider uk-child-width-expand@s grid" data-uk-grid>
               ...
               <div className="uk-width-1-3@s">
                  <div className="uk-flex uk-flex-column uk-width-1-1 feature-item">
                     ...
                     <div className="feature-desc uk-text-left uk-margin-small-top">
                        在设计接口的时候借鉴了Java和Qt的接口设计思想，在不改变Zend Engine原本语义的前提下对上层应用提供比C更抽象的接口，通过运算符和函数重载简化的大量的C的宏调用，同时我们引入了PHP相关的操作系统，让写扩展像写PHP那样舒服。
                     </div>
                  </div>
               </div>
               <div className="uk-width-1-3@s">
                  <div className="uk-flex uk-flex-column uk-width-1-1 feature-item">
                     ...
                     <div className="feature-desc uk-text-left uk-margin-small-top">
                        C++的性能远远高于PHP，在计算密集的模块使用C++编写能大大提高系统的性能，zendAPI项目在性能和开发效率上进行权衡，让您在不大量损失开发效率的情况下，编写高性能的扩展应用，为您节约成本。
                     </div>
                  </div>
               </div>
               ...
               <div className="uk-width-1-3@s">
                  <div className="uk-flex uk-flex-column uk-width-1-1 feature-item">
                     ...
                     <div className="feature-desc uk-text-left uk-margin-small-top">
                        一个好的开源项目，怎么强调文档都不为过，有时候甚至比代码还重要，我们提供完善的用户手册和每个接口的开发文档，这些文档我们尽最大努力提高阅读体验，至少能在PC，Pad和手机上进行无缝阅读。
                     </div>
                  </div>
               </div>
               <div className="uk-width-1-3@s">
                  <div className="uk-flex uk-flex-column uk-width-1-1 feature-item">
                     ...
                     <div className="feature-desc uk-text-left uk-margin-small-top">
                        项目采用C++11进行编写，最新的C++标准在程序的效率和代码的可阅读性上做了很多努力，我们会紧跟C++标准步伐，将更好的编程体验带到zendAPI项目中，尽最大努力提高项目的效率和可阅读性，让您更胸有成竹。
                     </div>
                  </div>
               </div>
               <div className="uk-width-1-3@s">
                  <div className="uk-flex uk-flex-column uk-width-1-1 feature-item">
                     ...
                     <div className="feature-desc uk-text-left uk-margin-small-top">
                        zendAPI是在Zend Engine之上进行实现的开源项目，采用BSD开源协议，项目代码托管下GitHub项目库中，您可以无忧无虑的在您的项目中进行使用。Just enjoy it!
                     </div>
                  </div>
               </div>
            </div>
